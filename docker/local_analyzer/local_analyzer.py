...
async def analyze_transaction(
    ...
    x_experiment_case:    Optional[str] = Header(None, description="Override experiment_case (로깅용)"),
    ...
    # Header 값이 있으면 우선, 없으면 ConfigMap(환경변수) 기본값 사용
    ...
    try:
        return _run_single(
            ...
            tree_rules_used = effective_tree_rules_enabled,
            mode            = "single",
        )
